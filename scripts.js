...
function removeFunc() {
  del.forEach((item) => {
    item.addEventListener('click', (event)=> {
      console.log(event.target.parentElement.parentElement.querySelector(".list-text").value );
      if(event.target.parentElement.parentElement.querySelector(".list-text").value !='' && event.target.parentElement.parentElement.querySelector(".list-text").readOnly != true){
        event.target.parentElement.parentElement.querySelector(".list-text").value = "";
      }
      else if(event.target.parentElement.parentElement.querySelector(".list-text").readOnly == true && event.target.parentElement.parentElement.querySelector(".list-text").value !='') {
